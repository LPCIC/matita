...
Thus we show that, in practice, the fragment is quite expressive
and is expressive enough to specify a realistic elaborator.
...
% 
% An expression is in the \frag{} iff every occurrence of an
% existentially quantified $X^j$ occurs applied to $x_j \ldots x_{j+k-1}$ for $k \ge 0$.
% 
...
%When applicable we compare softwares compiled to native code or interpreted.
