...
The functions implemented in the kernel already allow to build proofs in bottom-up style. CONTINUARE PARLANDO DELLE PROVE TOP-DOWN E DELLE METAVARIABILI
