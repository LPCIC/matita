...
program in Example 1.  Due to limitations in \tedius{} we reached a max
value of 321 for $n$ and we iterate the test a thousands of times.
...
\begin{center}
  ...
  \begin{tabular}{|p{1.5cm}||c|r||c|r||c|c|}
    ...
    \hline     
    \hline
    lambda3 &  1.91 & 5,068 &  5.45 & 237,860 &  0.35 & 0.02 \\
    \hline
