...
\begin{description}
\item[DBL1] the name of an occurrence of a variable does not depend on the (extra) context under which it occurs, i.e. $x$ is named $x_0$ everywhere;
\item[DBL2]
...
typed $lambda$-calculus) and that has all free variables visible by $X^j$ (all
